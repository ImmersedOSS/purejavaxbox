...
public class SinglePlayerTest
{
    ...
    public void singlePlayer()
    {
        ...
        SinglePlayer player = new SinglePlayer.Builder().timing(100)
                                                        .get();

        Phaser phaser = new Phaser(2);
        player.observeToggle(XboxButton.A)
              .filter(b -> b)
        ...
        player.observe(XboxButton.LEFT_STICK_VERTICAL)
              ...
              .subscribe(s -> System.out.println(String.format("%d %s %s", diff.get(), s,
        ...
        double timeInSeconds = TimeUnit.NANOSECONDS.toMillis(System.nanoTime() - start)
                / (double) millisInASecond;
